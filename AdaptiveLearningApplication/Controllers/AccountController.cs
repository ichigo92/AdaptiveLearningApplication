...
using AdaptiveLearningApplication.Filters;
...
namespace AdaptiveLearningApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult RoleAddToUser()
        {
            ...
            //SelectList userlist = new SelectList(User.)
        ...
        public ActionResult DeleteRoleForUser(string UserName, string RoleName)
        {
            ...
            //Now, there might be scenario where you need to check into the code block for a particular role for the
            //user before performing certain activity, to do that use below code
